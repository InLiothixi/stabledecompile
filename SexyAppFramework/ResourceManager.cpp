...
{
	return mLoadedGroups.find(StringToSexyString(theGroup)) != mLoadedGroups.end();
}
...
void ResourceManager::DeleteResources(const std::string& theGroup)
{
	...
	mLoadedGroups.erase(StringToSexyString(theGroup));
}
		...
		for (;;)
		{
			...
			if (aXMLElement.mType == XMLElement::TYPE_START)
			{
				if (aXMLElement.mValue == _S("Resources"))
				{
					...
					mCurResGroupList = &mResGroupMap[StringToSexyString(mCurResGroup)];
...
bool ResourceManager::ParseResourcesFile(const SexyString& theFilename)
{
	...
	if (!mXMLParser->OpenFile(theFilename))
		Fail("Resource file not found: " + SexyStringToString(theFilename));
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SharedImageRef ResourceManager::LoadImageA(const std::string& theName)
{
...
SharedImageRef ResourceManager::LoadImageW(const std::string& theName)
{
	ResMap::iterator anItr = mImageMap.find(theName);
	if (anItr == mImageMap.end())
		return NULL;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
Font* ResourceManager::LoadFont(const SexyString& theName)
{
	ResMap::iterator anItr = mFontMap.find(SexyStringToString(theName));
...
void ResourceManager::StartLoadResources(const std::string& theGroup)
{
	...
	mCurResGroupList = &mResGroupMap[StringToSexyString(theGroup)];
...
{
	const ResList* rl = &mResGroupMap.find(StringToSexyString(mCurResGroup))->second;
