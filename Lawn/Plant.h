...
{
    MAGNET_ITEM_NONE,
    MAGNET_ITEM_BUCKET_1,
    MAGNET_ITEM_BUCKET_2,
    MAGNET_ITEM_BUCKET_3,
...
public:
    ...
    SeedType                mDuplicatorSeedType;                  //+0x138
...
public:
    ...
    bool                    IsSpiky();
    static /*inline*/ bool  PreloadPlantResources(SeedType theSeedType);
